...
import { UnionAnnouncementManager } from "./UnionAnnouncementManager";
import { AdvertisementManager } from "./AdvertisementManager";
import { GCAManager } from "./GCAManager";
...
type Section = "announcements" | "advertisements" | "gcaManagement" | "divisionManagement" | "memberManagement";
...
const sections: SectionButton[] = [
  { key: "announcements", title: "Union Announcements", icon: "megaphone", outlineIcon: "megaphone-outline" },
  { key: "advertisements", title: "Advertisement Management", icon: "pricetag", outlineIcon: "pricetag-outline" },
  { key: "memberManagement", title: "Member Management", icon: "people", outlineIcon: "people-outline" },
  { key: "gcaManagement", title: "GCA Management", icon: "ribbon", outlineIcon: "ribbon-outline" },
  { key: "divisionManagement", title: "Division Management", icon: "business", outlineIcon: "business-outline" },
];

// Mobile breakpoint for web
const MOBILE_BREAKPOINT = 768;

export const UnionAdminPanel = forwardRef<View, {}>((props, ref: Ref<View>) => {
  ...
  const renderSection = () => {
    const Component = (() => {
      switch (activeSection) {
        case "announcements":
          return UnionAnnouncementManager;
        case "advertisements":
